...
document.querySelector('#orderRows').addEventListener('click', async (event) => {
  ...
  const button = verifyButton || rejectButton;
  if (!button) return;
