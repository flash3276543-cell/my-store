...
async function adminCreate(req, res, next) {
  try {
    ...
    // Plaintext key is shown here immediately for convenience; it's now
    // also recoverable later from the customer's own account (My
    // Licenses), since it's stored encrypted, not just hashed.
