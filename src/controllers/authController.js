...
/**
 * POST /api/auth/logout — clears the session cookie (works for both
 * admin and customer sessions, since they share the same cookie name).
 * No auth required: calling it while already logged out is harmless and
 * idempotent — it just clears a cookie that may or may not be there.
 */
...
module.exports = { adminLogin, register, login, me, logout };
