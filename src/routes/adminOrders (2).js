...
/** POST /api/admin/orders/:id/cancel — cancel an order in any state (e.g. a completed one). */
router.post('/:id/cancel', [param('id').isUUID().withMessage('Invalid order id.')], runValidation, orderController.adminCancel);
